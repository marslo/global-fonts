...
** installation
+ install stylus extension for [[https://chrome.google.com/webstore/detail/stylus/clngdbkpkpeebahjckkjfobafhncgmne][Stylus]] | [[https://chrome.google.com/webstore/detail/stylus/clngdbkpkpeebahjckkjfobafhncgmne][Chrome]], [[https://addons.mozilla.org/pt-BR/firefox/addon/styl-us/][Firefox]]
+ click to install 📦 [[https://userstyles.world/api/style/5264.user.css][global fonts (marslo)]]

** fonts download

#+BEGIN_QUOTE
+ more detals : [[https://marslo.github.io/ibook/][iMarlso: fonts]]
#+END_QUOTE
...
+ [[https://github.com/marslo/global-fonts/blob/main/global-fonts.use.css#L507][css]]
  #+BEGIN_SRC css
  html {
